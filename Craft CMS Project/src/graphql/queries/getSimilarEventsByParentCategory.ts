...
export const GET_SIMILAR_EVENTS_BY_PARENT_CATEGORY = gql`
  query getSimilarEventsByParentCategory ($site: [String]!, $productCategoryIds: [QueryArgument], $startDateFilter: [QueryArgument]) {
